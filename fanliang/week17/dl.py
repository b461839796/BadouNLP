...
class DialogueSystem:
    ...
    def load(self):
        ...
        self.load_scenario(os.path.join(dir_path, "scenario-买衣服.json"))
        # self.load_scenario(os.path.join(dir_path, "scenario-看电影.json"))
        self.load_slot_templet(os.path.join(dir_path, "slot_fitting_templet.xlsx"))
    ...
    def run(self, query, memory):
        ...
        if "policy" not in memory or memory["policy"] != "again":
